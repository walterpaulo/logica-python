...
def exec():
    ...
    print("Estamos com a capacidade de {:0.2f}% em nossos tanques\n".format(
        total_porcentagem))
    ...
    print(
        f"::: Ficou com {sobrou_no_tanque_do_posto} litros de um total de {atual_posto} litros de combustível no tanque do posto ::::")
